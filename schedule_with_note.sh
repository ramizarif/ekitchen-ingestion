...
echo "=== Next Check Note ($(date)) ===" > /Users/ramiz/ekitchen/ekitchen-ingestion/next_check_note.txt
echo "Scheduled for: $MINUTES minutes" >> /Users/ramiz/ekitchen/ekitchen-ingestion/next_check_note.txt
echo "" >> /Users/ramiz/ekitchen/ekitchen-ingestion/next_check_note.txt
echo "$NOTE" >> /Users/ramiz/ekitchen/ekitchen-ingestion/next_check_note.txt
...
nohup bash -c "sleep $SECONDS && tmux send-keys -t $TARGET 'Time for orchestrator check! cat /Users/ramiz/ekitchen/ekitchen-ingestion/next_check_note.txt && /changelog-summary --compact' && sleep 1 && tmux send-keys -t $TARGET Enter" > /dev/null 2>&1 &
